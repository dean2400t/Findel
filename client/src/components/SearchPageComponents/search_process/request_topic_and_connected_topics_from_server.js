...
{
    axios.get("/api/topics_to_topics/search_for_connected_topics_in_db_and_wikipedia/?search="+this_of_searchPage.curSearch,{
        headers: {'findel-auth-token': this_of_searchPage.token}
})
.then(async(result) => {

    this_of_searchPage.connected_topics_edges= result.data.connected_topics_edges;
