    ...
    render() {
        return this.props.domains.map((domain)=>(
            <div className="domains_div">
                ...
                <text>ציון על פי אנשים שאהבו דפים בדומיין: {domain.liked_weight} <br/></text>
                <text>ציון על פי אנשים שאמרו שהדפים בדומיין אמינים: {domain.credibility_weight} <br/></text>
                <text>ציון על פי אנשים שאמרו שהדפים בדומיין חינוכיים: {domain.educational_weight} <br/></text>
